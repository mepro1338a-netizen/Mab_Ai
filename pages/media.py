...
def render_video_page():
    ...
    st.markdown(
        ...
        <div class="page-card">
            ...
            <p style="font-size:20px;color:#d4d4d8;line-height:1.7;">
                Generiere AI-Videos für Reels, Ads, Social Media und Content-Kampagnen.
            </p>
        </div>
        """,
        unsafe_allow_html=True,
    ...
    prompt = st.text_area(
        ...
        key="video_prompt",
        height=200,
        placeholder="Cinematic product video, neon energy waves, slow camera movement...",
    )
...
def render_music_page():
    ...
    st.info("Music Modul verbinden wir als nächstes.")
...
def render_reels_page():
    ...
    st.info("Reels Modul verbinden wir als nächstes.")