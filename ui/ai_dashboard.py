...
from database import list_usage, recent_activity, usage_summary
...
def render_home() -> None:
    """Home page — Football Intelligence Command Center."""
...
# ---------------------------------------------------------------------------
# Inline: ui.dashboard_ui (Account profile + shared helpers)
# ---------------------------------------------------------------------------
