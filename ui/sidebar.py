"""
MaByte Sidebar — minimal, scrollable nav (HTML + session-safe ?nav= links).
"""
...
.sb-shell{{
  ...
  padding:10px 0 6px;box-sizing:border-box;overflow:hidden;
}}
.sb-brand{{
...
.sb-nav{{display:flex;flex-direction:column;gap:3px;padding-bottom:10px;}}
.sb-section{{
